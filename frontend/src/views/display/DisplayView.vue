  ...
  if (appModeStore.mode === 'visualizer') {
    return {
      visualizer: {
        ...
        hydra_colorfulness: visualizerStore.hydraColorfulness,
        hydra_scene_change_rate: visualizerStore.hydraSceneChangeRate,
        hydra_symmetry_amount: visualizerStore.hydraSymmetryAmount,
        hydra_feedback_amount: visualizerStore.hydraFeedbackAmount,
        hydra_quality: visualizerStore.hydraQuality,
        hydra_audio_reactivity_enabled: visualizerStore.hydraAudioReactivityEnabled,
        hydra_palette_mode: visualizerStore.hydraPaletteMode,
        overlay_mode: visualizerStore.overlayMode,
