...
import AdminVisualizerManagerView from '../views/admin/AdminVisualizerManagerView.vue'
  ...
  routes: [
    ...
    },
    {
      ...
      children: [
        ...
        {
          path: 'admin/visualizers',
          name: 'admin-visualizers',
          component: AdminVisualizerManagerView,
          meta: { audience: 'admin', requiresAuth: true, requiredRole: 'admin' },
        },
        {
          path: 'setup',
